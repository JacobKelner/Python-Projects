...
class UniversityClasses(models.Model):  # Creates class with models import
    title = models.CharField(max_length=55, default="", blank=True, null=False)  # Class attribute with specifications of User input
    course_number = models.IntegerField(default="", blank=True, null=False)
    instructor_name = models.CharField(max_length=55, default="", blank=True, null=False)
